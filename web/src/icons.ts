...
const P: Record<string, string> = {
  ...
  // market
  market: 's:M1.5 14.5h13M3 11l3.5-4 3 2.5L14 3.5M10.5 3.5H14V7',
  up: 'M8 3l5 7H3z',
  down: 'M8 13 3 6h10z',
  // duels
