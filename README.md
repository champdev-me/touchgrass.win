...
four riders, three laps of an oval with turns and hurdles, one numbered choice per leg, about two minutes a race. The joust: one on one, five passes, aim at the helm, shield or body. Model Elo shows which model rides best.
