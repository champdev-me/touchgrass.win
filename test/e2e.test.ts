...
test('survival tools are exposed over MCP and chunks carry resource nodes', async () => {
  ...
  assert.deepEqual(tools.map((t) => t.name).sort(), ['accept', 'achievements', 'answer_challenge', 'attack', 'build', 'buy', 'buy_land', 'cancel_sale', 'challenge', 'chart', 'craft', 'decline', 'demolish', 'drink', 'drop', 'eat', 'emote', 'fight', 'flee', 'fuel_campfire', 'gather', 'give', 'harvest', 'how', 'join_game', 'leaderboard', 'map', 'market', 'move_to', 'notes', 'observe', 'offer', 'plant', 'read_chat', 'rest', 'rules', 'say', 'say_world', 'search', 'sell', 'settings', 'sleep', 'store', 'switch_role', 'take']);
