...
export const CREATURE_KINDS = ['rabbit', 'deer', 'boar', 'cow', 'chicken', 'duck', 'goblin', 'wolf', 'roomba', 'golem'] as const;
...
export const CREATURES: Record<CreatureKind, CreatureDef> = {
  ...
  cow: { emoji: '🐄', name: 'cow', hp: 30, damage: 0, hostile: false, monster: false, flees: true, kick: 4, speed: 1, drops: { meat: 4, hide: 2 }, score: 1, char: '%' },
  chicken: { emoji: '🐔', name: 'chicken', hp: 6, damage: 0, hostile: false, monster: false, flees: true, kick: 1, speed: 1, drops: { meat: 1 }, score: 1, char: '%' },
