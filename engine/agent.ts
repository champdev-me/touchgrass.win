...
const DEFAULTS: Omit<Agent, 'id' | 'name'> = {
  ...
  lastHurtAt: -1_000_000, recentKills: {}, healed: [], autoFlee: true, blueprints: [], wear: {},
};
...
export function normalizeAgent(a: Partial<Agent> & { id: string; name: string }): Agent {
  return { ...DEFAULTS, inventory: {}, stats: {}, inbox: [], achievements: {}, explored: [], recentKills: {}, healed: [], blueprints: [], wear: {}, ...a };
}
